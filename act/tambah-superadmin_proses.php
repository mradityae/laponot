...
if(isset($_POST['submit']) && isset($_SESSION['email']) && (($_SESSION['user_role']) == 0))
{
	...
	try
	{
		...
		if(cekEmail($koneksi, $email))
		{
			...
			if (tambahNotaris($koneksi, $nama, $jenis_kelamin, $kedudukan, $skPengangkatan, $tglSkPengangkatan, $baPelantikan, $tglBaPelantikan ,$alamat, $telepon, $email, $password, $level, 1, $fullDirBaru)) 
			{
