...
<head>
    ...
    <title>RESET PASSWORD APLIKASI LAPORAN NOTARIS</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">RESET PASSWORD APLIKASI LAPORAN NOTARIS</h1>
                    </div>
                </div>
              <!-- /. ROW  -->
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <form action="<?=$url;?>act/reset_password_proses.php" method="POST">                                    
                                     <div class="col-md-12">
                                        <label>Email</label>
                                        <input type="email" name="email" class="form-control" aria-describedby="emailKet" placeholder="Pastikan Email Anda Sudah Terdaftar Pada Aplikasi Laporan Notaris" required/>
                                        <small id="emailKet" class="form-text text-muted">
                                         Password Baru Anda Akan Dikirimkan Ke Email Terdaftar
                                        </small>
                                        <br><br>
                                    </div>
