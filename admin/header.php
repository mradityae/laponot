...
<head>
    ...
    <title>LAPORAN NOTARIS - ADMIN</title>
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href=""><i class="fa fa-users"></i>Notaris <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level ">
                            <li>
                                <a href="daftar_notaris"><i class="fa fa-file-text-o"></i>Daftar Notaris</a>
                            </li>
                            <li>
                                <a href="tambah_notaris"><i class="fa fa-plus-square-o "></i>Tambah Notaris</a>
                            </li>
                        </ul>
                    </li>

                    <li>
                        <a href=""><i class="fa fa-book "></i>Rekap Data <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level ">
                            <li>
                                 <a href="rekap_data"><i class="fa fa-file-text-o"></i>Laporan Bulanan</a>
                            </li>
                            <li> <a href="rekap_data_notaris"><i class="fa fa-book"></i>Notaris</a>
                            </li>
                            <li>
                                 <a href="rekap_data_entitas"><i class="fa fa-file-text-o"></i>Laporan Fidusia</a>
                            </li>
                        </ul>
                    </li>
                    <li>
