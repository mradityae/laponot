...
?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line" align="left">Tambah Notaris</h1>
                    </div>
                </div>
              <!-- /. ROW  -->
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <form action="<?=$url;?>act/tambah-admin_proses.php" method="POST">
                                    <div class="col-md-12">
                                        <label>Nama</label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="kedudukan" class="form-control">
                                          <?php
                                              $ambil=$koneksi->prepare("SELECT * FROM kedudukan where id_kedudukan=:id_kedudukan");
                                              $ambil->BindParam(":id_kedudukan", $kedudukan, PDO::PARAM_STR);
                                              $ambil->execute();
