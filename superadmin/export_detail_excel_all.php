...
while (
    ...
    $sheet->setCellValue(
        "A{$row}",
        "DAFTAR KEPATUHAN LAPORAN NOTARIS - BELUM LENGKAP"
    );
...
$filename =
    'Detail_Kepatuhan_Notaris_Belum_Lengkap_' .
    $th .
    '_' .
    $b1 .
    '-' .
