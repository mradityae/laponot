<div id="footer-sec">
  ...
  <script type="text/javascript">
      ...
      function deletepelantikan(idpelantikan)
      {
          var konfirmasi = confirm("Apakah Anda yakin akan menghapus data ?");
          if (konfirmasi) {
              window.location ="<?=$url;?>act/hapus_pelantikan.php?idpelantikan="+idpelantikan;
          }
      }
        
      function deletepengguna(idnotaris)
      {
          var konfirmasi = confirm("Apakah Anda yakin akan menghapus data ?");
          if (konfirmasi) {
              window.location ="<?=$url;?>act/hapus_penggunasuper.php?idnotaris="+idnotaris;
          }
      }
